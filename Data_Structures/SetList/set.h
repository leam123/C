...
Set initialize(); //initialize to NULL
void display(Set s); // display on the screen all valid elements on the list
Set add(Set s, int elem); // store elem on the list 
int contain(Set s, int elem); //search the array elements for the value elem
